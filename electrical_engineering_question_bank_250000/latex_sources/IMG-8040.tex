...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-8040 | Signals and Systems | EE-160781};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {A signal is band-limited to 1.5 kHz. What minimum sampling rate avoids aliasing?};
\end{tikzpicture}
\end{document}
