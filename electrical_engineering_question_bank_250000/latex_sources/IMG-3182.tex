...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-3182 | Transmission Lines | EE-63621};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {A lossless line has L = 250 nH/m and C = 100 pF/m. What is Z0?};
\end{tikzpicture}
\end{document}
