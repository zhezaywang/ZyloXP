...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-4116 | Power Systems | EE-82301};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {A balanced three-phase load has line voltage 8 kV, line current 150 A, and power factor 0.95.\\What real power is delivered?};
\end{tikzpicture}
\end{document}
