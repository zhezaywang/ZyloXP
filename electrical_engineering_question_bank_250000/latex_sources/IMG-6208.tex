...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-6208 | Analog Electronics and Op-Amps | EE-124141};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {An ideal inverting amplifier has Rin = 10 kohm and Rf = 100 kohm. What is the voltage gain?};
\end{tikzpicture}
\end{document}
