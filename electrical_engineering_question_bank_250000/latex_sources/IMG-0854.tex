...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-0854 | AC Phasors and Impedance | EE-17061};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {A voltage is v(t) = 54 V cos(omega t + 30 deg). What is the RMS phasor magnitude?};
\end{tikzpicture}
\end{document}
