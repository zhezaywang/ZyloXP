...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-9829 | Measurement and Instrumentation | EE-196564};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {An 11 V source has source resistance 70 kohm and is measured by a voltmeter of 700 kohm input\\resistance. What voltage is read?};
\end{tikzpicture}
\end{document}
