...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-0221 | DC Circuit Analysis | EE-04401};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {A 20 V source is applied across a 20 ohm resistor. What current flows?};
\end{tikzpicture}
\end{document}
