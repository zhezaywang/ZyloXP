...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-2436 | Transient Circuit Analysis | EE-48701};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {An RC circuit has R = 5 kohm and C = 90 uF. What is the time constant?};
\end{tikzpicture}
\end{document}
