...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-2323 | Transient Circuit Analysis | EE-46443};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {An initially unenergized series RL circuit is connected at the switching instant to 12 V\\through 8 ohm. What is the inductor current after 2 time constants?};
\end{tikzpicture}
\end{document}
