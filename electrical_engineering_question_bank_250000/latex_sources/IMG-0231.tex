...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-0231 | DC Circuit Analysis | EE-04601};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {A 50.75 V source is applied across a 29 ohm resistor. What current flows?};
\end{tikzpicture}
\end{document}
