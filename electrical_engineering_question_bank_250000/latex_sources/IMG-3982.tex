...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-3982 | Power Systems | EE-79621};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {A balanced three-phase load has line voltage 7 kV, line current 275 A, and power factor 0.9.\\What real power is delivered?};
\end{tikzpicture}
\end{document}
