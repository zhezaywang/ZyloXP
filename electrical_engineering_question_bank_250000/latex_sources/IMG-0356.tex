...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-0356 | DC Circuit Analysis | EE-07101};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {A 7 V source is applied across a 14 ohm resistor. What current flows?};
\end{tikzpicture}
\end{document}
