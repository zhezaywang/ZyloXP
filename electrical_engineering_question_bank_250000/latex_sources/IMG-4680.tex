...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-4680 | Transformers and Electrical Machines | EE-93581};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {An ideal transformer has Np = 180, Ns = 140, and primary voltage 480 V. What is the secondary\\voltage?};
\end{tikzpicture}
\end{document}
