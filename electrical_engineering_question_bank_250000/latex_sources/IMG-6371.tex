...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-6371 | Semiconductor Devices | EE-127401};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {A BJT has beta = 130 and base current 30 uA in active region. What is collector current?};
\end{tikzpicture}
\end{document}
