...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-9789 | Measurement and Instrumentation | EE-195764};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {A 5 V source has source resistance 10 kohm and is measured by a voltmeter of 100 kohm input\\resistance. What voltage is read?};
\end{tikzpicture}
\end{document}
