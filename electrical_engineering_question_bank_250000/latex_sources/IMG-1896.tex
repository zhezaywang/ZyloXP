...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-1896 | Transient Circuit Analysis | EE-37901};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {An RC circuit has R = 11 kohm and C = 30 uF. What is the time constant?};
\end{tikzpicture}
\end{document}
