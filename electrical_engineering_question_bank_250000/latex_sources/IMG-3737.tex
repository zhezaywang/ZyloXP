...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-3737 | Transmission Lines | EE-74721};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {A lossless line has L = 400 nH/m and C = 160 pF/m. What is Z0?};
\end{tikzpicture}
\end{document}
