...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-0446 | DC Circuit Analysis | EE-08901};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {An 8.25 V source is applied across a 11 ohm resistor. What current flows?};
\end{tikzpicture}
\end{document}
