...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-9569 | Measurement and Instrumentation | EE-191364};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {An 8 V source has source resistance 40 kohm and is measured by a voltmeter of 400 kohm input\\resistance. What voltage is read?};
\end{tikzpicture}
\end{document}
