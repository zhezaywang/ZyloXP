...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-4550 | Transformers and Electrical Machines | EE-90981};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {An ideal transformer has Np = 220, Ns = 110, and primary voltage 120 V. What is the secondary\\voltage?};
\end{tikzpicture}
\end{document}
