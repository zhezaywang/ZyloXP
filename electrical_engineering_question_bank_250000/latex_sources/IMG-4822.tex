...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-4822 | Transformers and Electrical Machines | EE-96421};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {An ideal transformer has Np = 240, Ns = 125, and primary voltage 240 V. What is the secondary\\voltage?};
\end{tikzpicture}
\end{document}
