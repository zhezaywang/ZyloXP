...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-9091 | Communications | EE-181801};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {A conventional AM signal has highest modulating frequency 1.5 kHz. What transmission bandwidth\\is required?};
\end{tikzpicture}
\end{document}
