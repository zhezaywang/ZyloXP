...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-1112 | AC Phasors and Impedance | EE-22221};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {A voltage is v(t) = 42 V cos(omega t + 30 deg). What is the RMS phasor magnitude?};
\end{tikzpicture}
\end{document}
