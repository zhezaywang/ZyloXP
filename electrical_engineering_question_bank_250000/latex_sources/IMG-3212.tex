...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-3212 | Transmission Lines | EE-64221};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {A lossless line has L = 325 nH/m and C = 130 pF/m. What is Z0?};
\end{tikzpicture}
\end{document}
