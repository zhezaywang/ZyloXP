...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-5890 | Analog Electronics and Op-Amps | EE-117781};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {An ideal inverting amplifier has Rin = 9 kohm and Rf = 72 kohm. What is the voltage gain?};
\end{tikzpicture}
\end{document}
