...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-3775 | Power Systems | EE-75481};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {A balanced three-phase load has line voltage 12 kV, line current 200 A, and power factor 0.9.\\What real power is delivered?};
\end{tikzpicture}
\end{document}
