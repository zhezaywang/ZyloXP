...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-4784 | Transformers and Electrical Machines | EE-95661};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {An ideal transformer has Np = 140, Ns = 80, and primary voltage 480 V. What is the secondary\\voltage?};
\end{tikzpicture}
\end{document}
