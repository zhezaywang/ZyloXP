...
\node[anchor=west,text=white,font=\bfseries\Large] at (48,56) {Ohm's law problem diagram};
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-0146 | DC Circuit Analysis | EE-02901};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {A 40.25 V source is applied across a 23 ohm resistor. What current flows?};
\end{tikzpicture}
\end{document}
