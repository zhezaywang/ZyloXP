...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {A 400:5 ideal current transformer, with saturation and ratio error neglected, carries 50 A\\primary current. What secondary current flows ideally?};
\end{tikzpicture}
\end{document}
