...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-7401 | Digital Logic | EE-148001};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {How many unique states can 9 binary bits represent?};
\end{tikzpicture}
\end{document}
