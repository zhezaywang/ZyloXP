...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-7551 | Signals and Systems | EE-151001};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {A signal is band-limited to 5 kHz. What is the theoretical Nyquist rate? Practical sampling\\must be higher.};
\end{tikzpicture}
\end{document}
