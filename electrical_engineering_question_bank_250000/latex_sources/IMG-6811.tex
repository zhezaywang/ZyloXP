...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-6811 | Semiconductor Devices | EE-136201};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {A BJT has beta = 210 and base current 50 uA in active region. What is collector current?};
\end{tikzpicture}
\end{document}
