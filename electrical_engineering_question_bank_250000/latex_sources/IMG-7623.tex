...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-7623 | Signals and Systems | EE-152443};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {A sine wave has peak amplitude 2 V. What is its RMS value?};
\end{tikzpicture}
\end{document}
