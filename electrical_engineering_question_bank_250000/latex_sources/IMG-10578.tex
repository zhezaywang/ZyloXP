...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-10578 | PCB Design and Signal Integrity | EE-211541};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {A PCB trace is 9 inch long with delay 180 ps/in. What is the one-way propagation delay?};
\end{tikzpicture}
\end{document}
