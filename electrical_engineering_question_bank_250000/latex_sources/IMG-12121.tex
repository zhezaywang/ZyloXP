...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {A 600:1 ideal current transformer, with saturation and ratio error neglected, carries 500 A\\primary current. What secondary current flows ideally?};
\end{tikzpicture}
\end{document}
