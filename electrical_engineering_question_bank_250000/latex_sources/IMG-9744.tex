...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-9744 | Measurement and Instrumentation | EE-194864};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {A 9 V source has source resistance 50 kohm and is measured by a voltmeter of 500 kohm input\\resistance. What voltage is read?};
\end{tikzpicture}
\end{document}
