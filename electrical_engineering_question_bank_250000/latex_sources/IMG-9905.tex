...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-9905 | Measurement and Instrumentation | EE-198085};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {A Wheatstone bridge balances with R1 = 350 ohm, R2 = 450 ohm, and R3 = 275 ohm. If R1/R2 =\\R3/Rx, what is Rx?};
\end{tikzpicture}
\end{document}
