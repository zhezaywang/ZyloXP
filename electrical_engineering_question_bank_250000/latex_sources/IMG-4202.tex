...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-4202 | Power Systems | EE-84021};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {A balanced three-phase load has line voltage 4 kV, line current 250 A, and power factor 0.75.\\What real power is delivered?};
\end{tikzpicture}
\end{document}
