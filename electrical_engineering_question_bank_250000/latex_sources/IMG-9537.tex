...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-9537 | Measurement and Instrumentation | EE-190721};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {An 16-bit ADC uses a 3.3 V reference. What is one LSB?};
\end{tikzpicture}
\end{document}
