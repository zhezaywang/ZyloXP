...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-3983 | Power Systems | EE-79641};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {A balanced three-phase load has line voltage 11 kV, line current 175 A, and power factor 0.85.\\What real power is delivered?};
\end{tikzpicture}
\end{document}
