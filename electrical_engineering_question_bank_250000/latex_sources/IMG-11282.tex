...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-11282 | RF and Antennas | EE-225621};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {What is the approximate free-space wavelength at 550 MHz?};
\end{tikzpicture}
\end{document}
