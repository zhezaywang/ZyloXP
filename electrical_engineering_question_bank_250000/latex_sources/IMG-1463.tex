...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-1463 | Network Theorems and Two-Port Networks | EE-29241};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {A Thevenin equivalent has Vth = 10 V and Rth = 6 ohm. What is the Norton current?};
\end{tikzpicture}
\end{document}
