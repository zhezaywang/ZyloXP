...
\node[anchor=west,text=white,font=\bfseries\Large] at (48,56) {Sine RMS problem diagram};
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-7838 | Signals and Systems | EE-156743};
...
\node[text=zyloInk] at (206,268) {SS-03};
\node[font=\small,text=zyloLine,text width=205pt,align=center] at (206,307) {Sine RMS};
...
\node[font=\ttfamily,text=zyloInk,text width=310pt,align=center] at (565,300) {Vrms = Vpeak/sqrt(2)};
...
\node[font=\small,text=zyloLine,text width=820pt,align=center] at (480,440) {Pure sinusoid.};
\path[draw=black!15,fill=white,rounded corners=10pt] (24,500) rectangle (936,574);
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {A sine wave has peak amplitude 5.5 V. What is its RMS value?};
\end{tikzpicture}
\end{document}
