...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-9063 | Communications | EE-181241};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {A conventional AM signal has highest modulating frequency 4 kHz. What transmission bandwidth\\is required?};
\end{tikzpicture}
\end{document}
