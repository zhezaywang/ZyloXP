...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-11131 | Embedded Systems | EE-222601};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {What is the bit time for a UART baud rate of 9600 baud?};
\end{tikzpicture}
\end{document}
