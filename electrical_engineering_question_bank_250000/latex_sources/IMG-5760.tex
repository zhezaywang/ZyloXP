...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-5760 | Analog Electronics and Op-Amps | EE-115181};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {An ideal inverting amplifier has Rin = 4 kohm and Rf = 40 kohm. What is the voltage gain?};
\end{tikzpicture}
\end{document}
