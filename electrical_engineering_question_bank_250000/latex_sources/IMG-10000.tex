...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-10000 | Measurement and Instrumentation | EE-199981};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {An 8-bit ADC uses a 10 V reference. What is one LSB?};
\end{tikzpicture}
\end{document}
