...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-11091 | Embedded Systems | EE-221801};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {What is the bit time for a UART baud rate of 115200 baud?};
\end{tikzpicture}
\end{document}
