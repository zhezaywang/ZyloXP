...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-11011 | Embedded Systems | EE-220201};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {What is the bit time for a UART baud rate of 57600 baud?};
\end{tikzpicture}
\end{document}
