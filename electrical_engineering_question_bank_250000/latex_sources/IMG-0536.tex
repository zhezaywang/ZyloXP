...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-0536 | DC Circuit Analysis | EE-10701};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {A 29.75 V source is applied across a 17 ohm resistor. What current flows?};
\end{tikzpicture}
\end{document}
