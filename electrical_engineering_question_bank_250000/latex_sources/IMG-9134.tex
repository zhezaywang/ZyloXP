...
\node[anchor=west,text=white,font=\bfseries\Large] at (48,56) {Power ratio in dB problem diagram};
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-9134 | Communications | EE-182664};
...
\node[text=zyloInk] at (206,268) {CM-04};
\node[font=\small,text=zyloLine,text width=205pt,align=center] at (206,307) {Power ratio in dB};
...
\node[font=\ttfamily,text=zyloInk,text width=310pt,align=center] at (565,300) {dB = 10 log10(P2/P1)};
...
\node[font=\small,text=zyloLine,text width=820pt,align=center] at (480,440) {Power ratio.};
\path[draw=black!15,fill=white,rounded corners=10pt] (24,500) rectangle (936,574);
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {What is the dB value of a power ratio of 100?};
\end{tikzpicture}
\end{document}
