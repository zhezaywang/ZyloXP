...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-4475 | Transformers and Electrical Machines | EE-89481};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {An ideal transformer has Np = 240, Ns = 155, and primary voltage 2400 V. What is the secondary\\voltage?};
\end{tikzpicture}
\end{document}
