...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-8341 | Control Systems | EE-166801};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {A stable negative-unity-feedback system has scalar DC forward gain K = 7. What is the closed-\\loop DC gain?};
\end{tikzpicture}
\end{document}
