...
\node[anchor=west,text=white,font=\bfseries\Large] at (48,56) {VSWR problem diagram};
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-3518 | Transmission Lines | EE-70343};
...
\node[text=zyloInk] at (206,268) {TL-03};
\node[font=\small,text=zyloLine,text width=205pt,align=center] at (206,307) {VSWR};
...
\node[font=\ttfamily,text=zyloInk,text width=310pt,align=center] at (565,300) {VSWR = (1 + |Gamma|)/(1 -\\|Gamma|)};
...
\node[font=\small,text=zyloLine,text width=820pt,align=center] at (480,440) {0 <= |Gamma| < 1.};
\path[draw=black!15,fill=white,rounded corners=10pt] (24,500) rectangle (936,574);
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {If |Gamma| = 0.33, what is the VSWR?};
\end{tikzpicture}
\end{document}
