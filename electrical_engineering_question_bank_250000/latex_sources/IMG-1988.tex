...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-1988 | Transient Circuit Analysis | EE-39743};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {An initially unenergized series RL circuit is connected at the switching instant to 22 V\\through 9 ohm. What is the inductor current after 1 time constant?};
\end{tikzpicture}
\end{document}
