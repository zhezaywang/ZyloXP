...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-0451 | DC Circuit Analysis | EE-09001};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {A 10 V source is applied across a 20 ohm resistor. What current flows?};
\end{tikzpicture}
\end{document}
