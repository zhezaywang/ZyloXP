...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-9624 | Measurement and Instrumentation | EE-192464};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {A 14 V source has source resistance 100 kohm and is measured by a voltmeter of 1000 kohm input\\resistance. What voltage is read?};
\end{tikzpicture}
\end{document}
