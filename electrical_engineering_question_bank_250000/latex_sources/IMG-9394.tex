...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-9394 | Measurement and Instrumentation | EE-187864};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {A 7 V source has source resistance 30 kohm and is measured by a voltmeter of 300 kohm input\\resistance. What voltage is read?};
\end{tikzpicture}
\end{document}
