...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-3768 | Power Systems | EE-75341};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {A balanced three-phase load has line voltage 4 kV, line current 300 A, and power factor 0.75.\\What real power is delivered?};
\end{tikzpicture}
\end{document}
