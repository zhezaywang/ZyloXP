...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-8925 | Communications | EE-178481};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {A conventional AM signal has highest modulating frequency 9 kHz. What transmission bandwidth\\is required?};
\end{tikzpicture}
\end{document}
