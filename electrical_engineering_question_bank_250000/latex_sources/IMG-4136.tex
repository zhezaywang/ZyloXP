...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-4136 | Power Systems | EE-82701};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {A balanced three-phase load has line voltage 11 kV, line current 325 A, and power factor 0.85.\\What real power is delivered?};
\end{tikzpicture}
\end{document}
