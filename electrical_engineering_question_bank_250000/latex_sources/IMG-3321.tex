...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-3321 | Transmission Lines | EE-66401};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {A lossless line has per-unit-length inductance L' = 275 nH/m and per-unit-length capacitance\\C' = 110 pF/m. What is Z0?};
\end{tikzpicture}
\end{document}
