...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-4167 | Power Systems | EE-83321};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {A balanced three-phase load has line voltage 8 kV, line current 300 A, and power factor 0.95.\\What real power is delivered?};
\end{tikzpicture}
\end{document}
