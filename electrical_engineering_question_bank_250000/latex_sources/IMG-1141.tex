...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-1141 | AC Phasors and Impedance | EE-22801};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {A voltage is v(t) = 58 V cos(omega t + 30 deg). What is the RMS phasor magnitude?};
\end{tikzpicture}
\end{document}
