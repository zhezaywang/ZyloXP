...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-4838 | Transformers and Electrical Machines | EE-96741};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {An ideal transformer has Np = 180, Ns = 50, and primary voltage 120 V. What is the secondary\\voltage?};
\end{tikzpicture}
\end{document}
