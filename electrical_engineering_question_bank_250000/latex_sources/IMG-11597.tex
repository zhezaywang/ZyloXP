...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-11597 | RF and Antennas | EE-231921};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {What is the approximate free-space wavelength at 350 MHz?};
\end{tikzpicture}
\end{document}
