...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-0021 | DC Circuit Analysis | EE-00401};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {An 8 V source is applied across a 8 ohm resistor. What current flows?};
\end{tikzpicture}
\end{document}
