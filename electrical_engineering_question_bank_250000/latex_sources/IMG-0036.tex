...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-0036 | DC Circuit Analysis | EE-00701};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {A 12.75 V source is applied across a 17 ohm resistor. What current flows?};
\end{tikzpicture}
\end{document}
