...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-7840 | Signals and Systems | EE-156781};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {A signal is band-limited to 9.5 kHz. What minimum sampling rate avoids aliasing?};
\end{tikzpicture}
\end{document}
