...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-2340 | Transient Circuit Analysis | EE-46781};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {An RC circuit has R = 5 kohm and C = 30 uF. What is the time constant?};
\end{tikzpicture}
\end{document}
