...
\node[anchor=west,text=white,font=\bfseries\Large] at (48,56) {ADC LSB size problem diagram};
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-9836 | Measurement and Instrumentation | EE-196701};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {A 10-bit ADC uses a 3.3 V reference. What is one LSB? Use the ideal unipolar convention LSB =\\Vref/2\textasciicircum{}N.};
\end{tikzpicture}
\end{document}
