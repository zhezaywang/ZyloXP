...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-9556 | Measurement and Instrumentation | EE-191101};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {A 14-bit ADC uses a 2.5 V reference. What is one LSB? Use the ideal unipolar convention LSB =\\Vref/2\textasciicircum{}N.};
\end{tikzpicture}
\end{document}
