...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-0166 | DC Circuit Analysis | EE-03301};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {A 1 V source is applied across a 2 ohm resistor. What current flows?};
\end{tikzpicture}
\end{document}
