...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-1799 | Network Theorems and Two-Port Networks | EE-35961};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {A Thevenin equivalent has Vth = 16 V and Rth = 4 ohm. What is the Norton current?};
\end{tikzpicture}
\end{document}
