...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-5950 | Analog Electronics and Op-Amps | EE-118981};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {An ideal inverting amplifier has Rin = 5 kohm and Rf = 30 kohm. What is the voltage gain?};
\end{tikzpicture}
\end{document}
