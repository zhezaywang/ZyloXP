...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-0111 | DC Circuit Analysis | EE-02201};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {A 28 V source is applied across a 14 ohm resistor. What current flows?};
\end{tikzpicture}
\end{document}
