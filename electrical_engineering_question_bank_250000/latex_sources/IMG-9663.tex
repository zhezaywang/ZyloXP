...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-9663 | Measurement and Instrumentation | EE-193241};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {An 14-bit ADC uses a 2.5 V reference. What is one LSB?};
\end{tikzpicture}
\end{document}
