...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-0491 | DC Circuit Analysis | EE-09801};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {A 36.25 V source is applied across a 29 ohm resistor. What current flows?};
\end{tikzpicture}
\end{document}
