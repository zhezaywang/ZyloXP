...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-11763 | RF and Antennas | EE-235241};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {What is the approximate free-space wavelength at 600 MHz?};
\end{tikzpicture}
\end{document}
