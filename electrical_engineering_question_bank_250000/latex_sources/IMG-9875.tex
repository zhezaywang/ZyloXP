...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-9875 | Measurement and Instrumentation | EE-197485};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {A Wheatstone bridge balances with R1 = 550 ohm, R2 = 650 ohm, and R3 = 325 ohm. If R1/R2 =\\R3/Rx, what is Rx?};
\end{tikzpicture}
\end{document}
