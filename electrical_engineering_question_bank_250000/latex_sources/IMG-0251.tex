...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-0251 | DC Circuit Analysis | EE-05001};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {A 4 V source is applied across a 8 ohm resistor. What current flows?};
\end{tikzpicture}
\end{document}
