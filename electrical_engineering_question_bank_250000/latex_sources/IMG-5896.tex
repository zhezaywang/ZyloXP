...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-5896 | Analog Electronics and Op-Amps | EE-117901};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {An ideal inverting amplifier has Rin = 3 kohm and Rf = 6 kohm. What is the voltage gain?};
\end{tikzpicture}
\end{document}
