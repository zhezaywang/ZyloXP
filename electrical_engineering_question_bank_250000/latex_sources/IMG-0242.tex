...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-0242 | DC Circuit Analysis | EE-04821};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {A 8.25 V source is applied across a 11 ohm resistor. What current flows?};
\end{tikzpicture}
\end{document}
