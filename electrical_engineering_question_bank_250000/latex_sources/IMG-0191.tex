...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-0191 | DC Circuit Analysis | EE-03801};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {A 24.75 V source is applied across a 11 ohm resistor. What current flows?};
\end{tikzpicture}
\end{document}
