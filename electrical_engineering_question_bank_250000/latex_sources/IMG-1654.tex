...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-1654 | Network Theorems and Two-Port Networks | EE-33061};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {A Thevenin equivalent has Vth = 18 V and Rth = 14 ohm. What is the Norton current?};
\end{tikzpicture}
\end{document}
