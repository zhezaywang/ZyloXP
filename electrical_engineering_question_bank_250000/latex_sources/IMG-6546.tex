...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-6546 | Semiconductor Devices | EE-130901};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {A BJT has beta = 150 and base current 35 uA in active region. What is collector current?};
\end{tikzpicture}
\end{document}
