...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-6384 | Semiconductor Devices | EE-127661};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {A BJT has beta = 230 and base current 55 uA in active region. What is collector current?};
\end{tikzpicture}
\end{document}
