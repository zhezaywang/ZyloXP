...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-10521 | PCB Design and Signal Integrity | EE-210401};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {A PCB trace is 12 inch long with delay 210 ps/in. What is the one-way propagation delay?};
\end{tikzpicture}
\end{document}
