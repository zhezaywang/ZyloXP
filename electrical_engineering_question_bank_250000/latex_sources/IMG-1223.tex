...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-1223 | AC Phasors and Impedance | EE-24441};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {A voltage is v(t) = 66 V cos(omega t + 30 deg). What is the RMS phasor magnitude?};
\end{tikzpicture}
\end{document}
