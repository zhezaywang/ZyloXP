...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-2116 | Transient Circuit Analysis | EE-42301};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {An RC circuit has R = 10 kohm and C = 100 uF. What is the time constant?};
\end{tikzpicture}
\end{document}
