...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-8777 | Communications | EE-175521};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {A conventional AM signal has highest modulating frequency 5.5 kHz. What transmission bandwidth\\is required?};
\end{tikzpicture}
\end{document}
