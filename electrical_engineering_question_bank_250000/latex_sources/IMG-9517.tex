...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-9517 | Measurement and Instrumentation | EE-190321};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {An 10-bit ADC uses a 5 V reference. What is one LSB?};
\end{tikzpicture}
\end{document}
