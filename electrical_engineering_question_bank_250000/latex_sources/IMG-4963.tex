...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-4963 | Transformers and Electrical Machines | EE-99241};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {An ideal transformer has Np = 280, Ns = 95, and primary voltage 2400 V. What is the secondary\\voltage?};
\end{tikzpicture}
\end{document}
