...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-3933 | Power Systems | EE-78641};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {A balanced three-phase load has line voltage 5 kV, line current 225 A, and power factor 0.8.\\What real power is delivered?};
\end{tikzpicture}
\end{document}
