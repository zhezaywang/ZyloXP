...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-0196 | DC Circuit Analysis | EE-03901};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {A 13.75 V source is applied across a 11 ohm resistor. What current flows?};
\end{tikzpicture}
\end{document}
