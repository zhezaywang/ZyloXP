...
\node[anchor=west,text=white,font=\bfseries\Large] at (48,56) {UART bit time problem diagram};
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-10916 | Embedded Systems | EE-218301};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {What is the bit time for a UART baud rate of 230400 baud?};
\end{tikzpicture}
\end{document}
