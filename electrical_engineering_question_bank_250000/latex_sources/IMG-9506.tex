...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-9506 | Measurement and Instrumentation | EE-190101};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {A 12-bit ADC uses a 5 V reference. What is one LSB? Use the ideal unipolar convention LSB =\\Vref/2\textasciicircum{}N.};
\end{tikzpicture}
\end{document}
