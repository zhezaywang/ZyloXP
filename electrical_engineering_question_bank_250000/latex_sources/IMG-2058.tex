...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-2058 | Transient Circuit Analysis | EE-41143};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {An initially unenergized series RL circuit is connected at the switching instant to 24 V\\through 8 ohm. What is the inductor current after 3 time constants?};
\end{tikzpicture}
\end{document}
