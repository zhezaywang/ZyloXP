...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-9959 | Measurement and Instrumentation | EE-199164};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {A 6 V source has source resistance 20 kohm and is measured by a voltmeter of 200 kohm input\\resistance. What voltage is read?};
\end{tikzpicture}
\end{document}
