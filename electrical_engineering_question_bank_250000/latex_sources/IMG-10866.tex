...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-10866 | Embedded Systems | EE-217301};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {What is the bit time for a UART baud rate of 19200 baud?};
\end{tikzpicture}
\end{document}
