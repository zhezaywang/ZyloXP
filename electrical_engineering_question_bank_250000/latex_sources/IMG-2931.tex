...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {Two point charges, 8 uC and 7 uC, are separated by 0.25 m in air. Using k = 8.98755e9 N\\m\textasciicircum{}2/C\textasciicircum{}2, what is the force magnitude?};
\end{tikzpicture}
\end{document}
