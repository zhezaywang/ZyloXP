...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-9939 | Measurement and Instrumentation | EE-198764};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {A 13 V source has source resistance 90 kohm and is measured by a voltmeter of 900 kohm input\\resistance. What voltage is read?};
\end{tikzpicture}
\end{document}
