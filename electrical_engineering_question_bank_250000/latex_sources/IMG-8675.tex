...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-8675 | Control Systems | EE-173481};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {A unity-feedback system has forward gain K = 2. What is the closed-loop DC gain?};
\end{tikzpicture}
\end{document}
