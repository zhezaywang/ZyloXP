...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-3389 | Transmission Lines | EE-67761};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {A lossless line has L = 300 nH/m and C = 120 pF/m. What is Z0?};
\end{tikzpicture}
\end{document}
