...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-2398 | Transient Circuit Analysis | EE-47943};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {An initially unenergized series RL circuit is connected at the switching instant to 22 V\\through 7 ohm. What is the inductor current after 2 time constants?};
\end{tikzpicture}
\end{document}
