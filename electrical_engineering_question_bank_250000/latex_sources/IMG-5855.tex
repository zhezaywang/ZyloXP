...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-5855 | Analog Electronics and Op-Amps | EE-117081};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {An ideal inverting amplifier has Rin = 6 kohm and Rf = 48 kohm. What is the voltage gain?};
\end{tikzpicture}
\end{document}
