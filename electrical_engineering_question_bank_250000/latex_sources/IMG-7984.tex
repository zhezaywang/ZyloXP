...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-7984 | Signals and Systems | EE-159661};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {A signal is band-limited to 6.5 kHz. What minimum sampling rate avoids aliasing?};
\end{tikzpicture}
\end{document}
