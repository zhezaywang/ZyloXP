...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-5846 | Analog Electronics and Op-Amps | EE-116901};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {An ideal inverting amplifier has Rin = 7 kohm and Rf = 28 kohm. What is the voltage gain?};
\end{tikzpicture}
\end{document}
