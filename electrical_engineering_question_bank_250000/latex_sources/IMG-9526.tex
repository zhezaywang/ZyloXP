...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-9526 | Measurement and Instrumentation | EE-190501};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {An 8-bit ADC uses a 3.3 V reference. What is one LSB? Use the ideal unipolar convention LSB =\\Vref/2\textasciicircum{}N.};
\end{tikzpicture}
\end{document}
