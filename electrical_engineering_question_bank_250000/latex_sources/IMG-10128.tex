...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-10128 | PCB Design and Signal Integrity | EE-202541};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {A PCB trace is 3 inch long with delay 200 ps/in. What is the one-way propagation delay?};
\end{tikzpicture}
\end{document}
