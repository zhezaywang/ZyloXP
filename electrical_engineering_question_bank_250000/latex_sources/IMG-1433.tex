...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-1433 | Network Theorems and Two-Port Networks | EE-28641};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {A Thevenin equivalent has Vth = 28 V and Rth = 16 ohm. What is the Norton current?};
\end{tikzpicture}
\end{document}
