...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-1621 | Network Theorems and Two-Port Networks | EE-32401};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {A Thevenin equivalent has Vth = 6 V and Rth = 10 ohm. What is the Norton current magnitude?};
\end{tikzpicture}
\end{document}
