...
\node[anchor=west,text=white!82,font=\small] at (48,80) {IMG-6937 | Digital Logic | EE-138721};
...
\node[anchor=west,text width=860pt,align=left,text=zyloInk,font=\normalsize] at (48,528) {How many unique states can 8 binary bits represent?};
\end{tikzpicture}
\end{document}
